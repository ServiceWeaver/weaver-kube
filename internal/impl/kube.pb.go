...
type BabysitterConfig struct {
	...
	TraceServiceUrl string           `protobuf:"bytes,3,opt,name=trace_service_url,json=traceServiceUrl,proto3" json:"trace_service_url,omitempty"`                                                     // if not empty, where to send traces
	Listeners       map[string]int32 `protobuf:"bytes,4,rep,name=listeners,proto3" json:"listeners,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // a map from listener name to port
}
...
func (x *BabysitterConfig) GetTraceServiceUrl() string {
	if x != nil {
...
var file_internal_impl_kube_proto_rawDesc = []byte{
	...
	0x22, 0x84, 0x02, 0x0a, 0x10, 0x42, 0x61, 0x62, 0x79, 0x73, 0x69, 0x74, 0x74, 0x65, 0x72, 0x43,
	...
	,
...
var file_internal_impl_kube_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_impl_kube_proto_goTypes = []interface{}{
	(*BabysitterConfig)(nil), // 0: impl.BabysitterConfig
	nil,                      // 1: impl.BabysitterConfig.ListenersEntry
}
var file_internal_impl_kube_proto_depIdxs = []int32{
	1, // 0: impl.BabysitterConfig.listeners:type_name -> impl.BabysitterConfig.ListenersEntry
