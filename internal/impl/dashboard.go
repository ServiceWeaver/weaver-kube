...
// grafanaDashboard generates the content of a Service Weaver dashboard that
// contains autogenerated metrics and the logs for a given app.
//
// TODO(rgrandl): see how we can display the traces as well. Traces is more
// complicated because it requires to specify a service name, which is not
// available before the application is running.
func grafanaDashboard(app string) string {
	return fmt.Sprintf(`{
  "annotations": {
    "list": [
      {
